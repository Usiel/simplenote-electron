...
// The toolbar CSS (`.tiptap-button-icon svg`) sizes every glyph to 1.125rem and
// applies `fill: currentColor`, so the `size` here only sets the SVG's intrinsic
// 24×24 viewBox; the rendered size is driven by CSS.
const ICON_SIZE = 24;
